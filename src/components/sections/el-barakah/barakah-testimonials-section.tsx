...
interface BarakahTestimonialsSectionProps {
  content: ElBarakahContent;
}

export function BarakahTestimonialsSection({ content }: BarakahTestimonialsSectionProps) {
      ...
      <div className="container">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-accent font-bold mb-6 text-mjaidri-dark">
            Ils Ont Choisi
            <br />
            <span className="text-gradient-barakah">EL BARAKAH</span>
          </h2>
          ...
          <p className="text-xl text-mjaidri-dark/80 max-w-3xl mx-auto leading-relaxed">
            ...
            d'EL BARAKAH leur nouveau chez-eux.
          </p>
        </motion.div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 h-full">
                    ...
                    <div className="p-8 md:p-12 flex flex-col justify-center">
                      ...
                      <motion.div
                        ...
                        className="w-16 h-16 rounded-full bg-gradient-barakah flex items-center justify-center mb-8"
                      >
                      ...
                      >
                        ...
                        <div className="grid grid-cols-1 gap-2 text-sm">
                          <div>
                            ...
                            <div className="font-semibold text-barakah-primary">
                    ...
                    {/* Visual Side */}
                    <div className="relative overflow-hidden bg-gradient-barakah">
                      {/* Highlight Badge */}
                      <motion.div
        ...
        >
          <div className="text-center">
            <div className="text-4xl font-bold text-gradient-barakah mb-2">95%</div>
            <div className="text-mjaidri-dark/70">Satisfaction Client</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-gradient-barakah mb-2">60j</div>
            <div className="text-mjaidri-dark/70">Délai Moyen d'Acquisition</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-gradient-barakah mb-2">24h</div>
